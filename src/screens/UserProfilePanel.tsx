      ...
      <aside aria-label="Profile Panel" className="absolute top-0 right-0 h-full w-full max-w-sm bg-surface-container border-l border-outline-variant z-50 flex flex-col shadow-2xl transition-transform duration-300 translate-x-0">
        ...
        <div className="flex-1 overflow-y-auto p-md space-y-md">
          ...
          <section>
            ...
            <div className="bg-surface rounded-lg border border-outline-variant overflow-hidden">
              <button
                className="w-full flex items-center p-md hover:bg-surface-variant transition-colors border-b border-outline-variant focus:outline-none focus:ring-2 focus:ring-primary-container focus:ring-inset"
              ...
              <button
                className="w-full flex items-center p-md hover:bg-surface-variant transition-colors focus:outline-none focus:ring-2 focus:ring-primary-container focus:ring-inset"
                onClick={() => navigate("settings")}
              >
          ...
          <section>
            ...
            <div className="bg-surface rounded-lg border border-outline-variant overflow-hidden">
              ...
              >
                ...
                <div className={`w-10 h-6 rounded-full relative transition-colors ${settings.darkTheme ? "bg-primary-container" : "bg-surface-variant"}`}>
                  <div className={`absolute top-1 w-4 h-4 bg-on-primary-container rounded-full transition-transform ${settings.darkTheme ? "right-1" : "left-1 bg-on-surface-variant"}`}></div>
                </div>
              </button>
              <button
                className="w-full flex items-center p-md hover:bg-surface-variant transition-colors focus:outline-none focus:ring-2 focus:ring-primary-container focus:ring-inset"
        ...
        <div className="p-lg border-t border-outline-variant bg-surface-container">
          ...
          <div className="mt-md flex justify-center space-x-md text-label-sm font-label-sm text-on-surface-variant">
            <button className="hover:text-on-surface underline" onClick={() => navigate("settings")}>Privacy Policy</button>
            <button className="hover:text-on-surface underline" onClick={() => navigate("settings")}>Terms of Service</button>
          </div>
