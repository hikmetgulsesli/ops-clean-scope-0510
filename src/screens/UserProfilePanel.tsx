...
export function UserProfilePanel(props: UserProfilePanelProps) {
  return (
    <>
      {/* Scrim / Backdrop */}
      <div aria-hidden={true} className="absolute inset-0 bg-background/80 backdrop-blur-sm z-40"></div>
      ...
      <button aria-label="Close Profile" className="h-touch-target w-touch-target flex items-center justify-center text-on-surface-variant hover:text-on-surface hover:bg-surface-variant rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-primary-container focus:ring-offset-2 focus:ring-offset-surface-container">
      ...
      <a className="flex items-center p-md hover:bg-surface-variant transition-colors border-b border-outline-variant focus:outline-none focus:ring-2 focus:ring-primary-container focus:ring-inset" href="#">
      ...
      <a className="flex items-center p-md hover:bg-surface-variant transition-colors focus:outline-none focus:ring-2 focus:ring-primary-container focus:ring-inset" href="#">
      ...
      <div className="bg-surface rounded-lg border border-outline-variant overflow-hidden">
      <button className="w-full flex items-center justify-between p-md hover:bg-surface-variant transition-colors border-b border-outline-variant focus:outline-none focus:ring-2 focus:ring-primary-container focus:ring-inset">
      ...
      <div className="absolute right-1 top-1 w-4 h-4 bg-on-primary-container rounded-full"></div>
      </div>
      </button>
      <a className="flex items-center p-md hover:bg-surface-variant transition-colors focus:outline-none focus:ring-2 focus:ring-primary-container focus:ring-inset" href="#">
      ...
      <button className="w-full flex items-center justify-center p-sm border border-outline-variant rounded bg-surface hover:bg-surface-variant transition-colors text-error focus:outline-none focus:ring-2 focus:ring-error focus:ring-offset-2 focus:ring-offset-surface-container h-touch-target">
      ...
      <a className="hover:text-on-surface underline" href="#">Privacy Policy</a>
      <a className="hover:text-on-surface underline" href="#">Terms of Service</a>
      </div>
