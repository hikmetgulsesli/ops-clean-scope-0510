      ...
      <nav className="hidden md:flex flex-col h-screen w-64 left-0 top-0 bg-surface-container-low dark:bg-surface-container-low border-r border-outline-variant dark:border-outline-variant p-md gap-base z-30 shrink-0">
        ...
        <div className="flex items-center gap-md mb-xl px-sm">
          <div className="w-10 h-10 rounded-full bg-surface-variant flex items-center justify-center shrink-0 overflow-hidden">
            <img alt="Ops Logo" className="w-full h-full object-cover" data-alt="A stylized, minimalist logo mark featuring sharp geometric shapes in deep blue and crisp white. The logo sits perfectly centered within a dark circular container. Lighting is even and professional, suggesting a modern enterprise software brand." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDwFeQzr6_9-sOk_4snd3d_rxwY17aIjjvPYutLLdWtI5BDUQ_6ouCrqAHWZt0O8oMt8yJAWjez3kqkyi75VDS9JJi9Ql95xnKLyyEFL7qC9E1bXj5bJ-CTZMfzA9UxNWh5i2al7wwRMlLzZEhwsonNCombCb3P1uYt5PgQMO9iwxypuj-2agvo4S8qsRL7tcsTeomsHNAv24iWIxFZxT_Ecs6lcgi9vcnwLIswMvSysOXW-TRskGjz9_YEk-x89PWJXK6Xdn6QL6U" />
          </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-margin">
          <div className="max-w-4xl mx-auto space-y-xl">
            {/* Page Header */}
            <div>
              <h1 className="text-headline-lg font-headline-lg text-on-surface mb-xs">Application Preferences</h1>
              <p className="text-body-md font-body-md text-on-surface-variant">Manage your workspace settings, notifications, and local data.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-lg">
              ...
              <section className="lg:col-span-8 bg-surface rounded-xl border border-[#334155] p-lg flex flex-col">
                ...
                <div className="space-y-lg flex-1">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-label-md font-label-md text-on-surface mb-base">System Alerts</h3>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-label-md font-label-md text-on-surface mb-base">Daily Digest</h3>
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        ...
                        onChange={() => updateSettings({ dailyDigest: !settings.dailyDigest })}
                      />
                      <div className="w-11 h-6 bg-surface-variant peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-primary-container rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-container border border-outline-variant"></div>
                    </label>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-label-md font-label-md text-on-surface mb-base">Weekly Report Generation</h3>
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        ...
                        onChange={() => updateSettings({ weeklyReport: !settings.weeklyReport })}
                      />
                      <div className="w-11 h-6 bg-surface-variant peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-primary-container rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-container border border-outline-variant"></div>
                    </label>
                  </div>
              ...
              <section className="lg:col-span-4 bg-surface rounded-xl border border-[#334155] p-lg flex flex-col relative overflow-hidden group">
                ...
                <div className="flex items-center gap-md mb-md border-b border-[#334155] pb-md relative z-10">
                  <span className="material-symbols-outlined text-on-surface-variant" style={{fontSize: "24px"}}>info</span>
                  <h2 className="text-headline-sm font-headline-sm text-on-surface">System Info</h2>
                </div>
                <div className="flex-1 flex flex-col justify-center gap-md relative z-10">
                  <div>
                    <span className="block text-label-sm font-label-sm text-on-surface-variant mb-base">Current Version</span>
                    <span className="block text-body-lg font-body-lg font-mono text-primary">v4.12.8-stable</span>
                  </div>
                  <div>
                    <span className="block text-label-sm font-label-sm text-on-surface-variant mb-base">Last Sync</span>
                    <span className="block text-body-md font-body-md text-on-surface">Today, 08:42 AM PST</span>
                  </div>
                  <div>
                    <span className="block text-label-sm font-label-sm text-on-surface-variant mb-base">Environment</span>
              ...
              <section className="lg:col-span-12 bg-surface rounded-xl border border-[#334155] p-lg flex flex-col md:flex-row items-start md:items-center justify-between gap-lg">
                <div className="max-w-xl">
                  <div className="flex items-center gap-md mb-xs">
                    <span className="material-symbols-outlined text-error" style={{fontSize: "24px"}}>database</span>
                    <h2 className="text-headline-sm font-headline-sm text-on-surface">Local Storage Management</h2>
                  </div>
                  <p className="text-body-md font-body-md text-on-surface-variant">
                    Clear cached operational data and temporary files stored on this device. This action cannot be undone and will require a full resync upon next login.
                  </p>
                </div>
                <div className="shrink-0">
                  {!confirmClear ? (
                    ...
                    <button
                      className="h-[44px] px-lg bg-error text-white text-label-md font-label-md rounded flex items-center justify-center gap-sm hover:bg-opacity-90 transition-colors focus:ring-2 focus:ring-error focus:ring-offset-2 focus:ring-offset-surface"
