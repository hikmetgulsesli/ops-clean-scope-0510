...
export function CreateEditRecord(props: CreateEditRecordProps) {
  return (
    <>
      ...
      <div>
      <h1 className="text-headline-md font-headline-md text-on-surface">New Entry</h1>
      <p className="text-body-sm font-body-sm text-on-surface-variant mt-xs">Create a new operational record.</p>
      </div>
      <button className="text-on-surface-variant hover:text-on-surface h-touch-target w-touch-target flex items-center justify-center rounded-full hover:bg-[#334155] transition-colors focus:outline-none focus:ring-2 focus:ring-[#2563EB] focus:ring-offset-2 focus:ring-offset-[#1E293B]">
      <span className="material-symbols-outlined" data-icon="close">close</span>
      </button>
      </div>
      {/* Form Content */}
      <form className="p-lg flex flex-col gap-lg bg-[#1E293B]">
      ...
      <input aria-describedby="title-error" aria-invalid="true" className="bg-[#1E293B] border border-error text-on-surface rounded-DEFAULT px-md py-sm focus:outline-none focus:border-error focus:ring-2 focus:ring-error focus:ring-opacity-50 h-[36px] md:h-[36px] h-touch-target transition-all text-body-md font-body-md" id="title" name="title" placeholder="Enter record title" type="text" value="Q4 Integration" />
      ...
      <select className="bg-[#1E293B] border border-[#334155] text-on-surface rounded-DEFAULT px-md py-sm appearance-none w-full focus:outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[#2563EB] focus:ring-opacity-50 h-[36px] md:h-[36px] h-touch-target transition-all text-body-md font-body-md pr-xl" id="status" name="status">
      ...
      <div className="relative">
      <select className="bg-[#1E293B] border border-[#334155] text-on-surface rounded-DEFAULT px-md py-sm appearance-none w-full focus:outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[#2563EB] focus:ring-opacity-50 h-[36px] md:h-[36px] h-touch-target transition-all text-body-md font-body-md pr-xl" id="priority" name="priority">
