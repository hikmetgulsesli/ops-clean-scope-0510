    ...
    <>
      ...
      <nav className="hidden md:flex flex-col h-screen w-64 left-0 top-0 p-md gap-base bg-surface-container-low border-r border-outline-variant shrink-0">
        ...
        <div className="flex flex-col gap-base flex-1">
          <a
            className="flex items-center gap-sm px-sm py-sm rounded-lg bg-secondary-container text-on-secondary-container cursor-pointer select-none"
          ...
          <a
            className="flex items-center gap-sm px-sm py-sm rounded-lg text-on-surface-variant hover:text-on-surface hover:bg-surface-variant transition-all duration-150 cursor-pointer select-none"
        ...
        <div className="mt-auto mb-lg">
          <button
            className="w-full bg-primary-container text-on-primary-container h-touch-target rounded-lg flex items-center justify-center gap-sm focus:outline-none focus:ring-2 focus:ring-primary-container focus:ring-offset-2 focus:ring-offset-background transition-colors hover:bg-opacity-90"
            onClick={goToCreate}
          >
        ...
        <header className="md:hidden flex justify-between items-center h-14 w-full px-gutter ml-auto bg-surface-container border-b border-outline-variant z-40 shrink-0">
          ...
          <div className="flex items-center gap-sm">
            <button
              ...
              className="w-10 h-10 flex items-center justify-center rounded-full text-on-surface-variant hover:bg-surface-bright transition-colors duration-200 cursor-pointer active:opacity-80"
          ...
          <div className="max-w-md w-full flex flex-col items-center text-center">
            ...
            <div className="w-48 h-48 mb-lg relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-surface-variant">
                <span className="material-symbols-outlined text-[80px]" data-icon="topic" data-weight="fill" style={{ fontVariationSettings: "'FILL' 1" }}>
                  topic
                </span>
              </div>
            </div>
            ...
            {/* Call to Action */}
            <button
              className="bg-primary-container text-white h-touch-target px-lg rounded flex items-center justify-center gap-sm focus:outline-none focus:ring-2 focus:ring-primary-container focus:ring-offset-2 focus:ring-offset-background transition-colors hover:bg-opacity-90"
              onClick={goToCreate}
            >
              <span className="material-symbols-outlined" data-icon="add">add</span>
