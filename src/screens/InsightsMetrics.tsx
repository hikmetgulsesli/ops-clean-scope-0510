...
export function InsightsMetrics(props: InsightsMetricsProps) {
  return (
    <>
      ...
      <a className="flex items-center gap-md px-md py-sm rounded-lg text-on-surface-variant hover:text-on-surface hover:bg-surface-variant dark:hover:bg-surface-variant transition-all duration-150 cursor-pointer select-none" href="#">
      <span className="material-symbols-outlined text-on-surface-variant">dashboard</span>
      <span className="text-label-md font-label-md">Dashboard</span>
      </a>
      {/* Active Tab */}
      <a className="flex items-center gap-md px-md py-sm rounded-lg bg-secondary-container dark:bg-secondary-container text-on-secondary-container dark:text-on-secondary-container cursor-pointer select-none" href="#">
      ...
      {/* CTA Button */}
      <button className="w-full bg-primary-container text-white text-label-md font-label-md h-9 rounded flex items-center justify-center gap-sm mt-auto mb-lg hover:bg-primary-container/90 transition-colors focus:ring-2 focus:ring-offset-2 focus:ring-offset-surface-container-low focus:ring-primary-container outline-none">
      ...
      <div className="flex items-center gap-sm">
      <button className="w-touch-target h-touch-target flex items-center justify-center text-on-surface-variant hover:bg-surface-bright transition-colors duration-200 rounded-full cursor-pointer active:opacity-80">
      ...
      <input className="bg-surface border border-outline-variant rounded pl-10 pr-4 py-1.5 text-body-sm font-body-sm text-on-surface placeholder-on-surface-variant focus:border-primary-container focus:ring-1 focus:ring-primary-container outline-none w-64 transition-all" placeholder="Search metrics..." type="text" />
      </div>
      <button className="w-9 h-9 flex items-center justify-center text-on-surface-variant hover:bg-surface-variant transition-colors rounded-full focus:ring-2 focus:ring-primary-container outline-none">
      ...
      <div className="text-[32px] leading-tight font-bold text-on-surface tracking-tight mb-xs">
                                  1.24 <span className="text-headline-sm font-headline-sm text-outline-variant font-normal">ms/req</span>
      </div>
      ...
      <span className="text-on-surface-variant">4,291</span>
      </div>
      ...
      <span className="text-on-surface-variant">1,830</span>
      </div>
      <div className="w-full bg-surface-container-high rounded-full h-2">
      <div className="bg-secondary-container h-2 rounded-full" style={{width: "28%"}}></div>
      </div>
      </div>
      {/* Row 3 */}
      <div>
      ...
      <span className="text-error mb-xs">42</span>
      </div>
      <div className="w-full bg-surface-container-high rounded-full h-2">
      <div className="bg-error-container h-2 rounded-full" style={{width: "7%"}}></div>
      </div>
      </div>
      </div>
      </div>
      ...
      <button className="text-label-sm font-label-sm text-primary hover:text-primary-fixed transition-colors">View All</button>
      </div>
      <div className="flex flex-col">
      {/* Activity Item 1 */}
      ...
      <a className="flex flex-col items-center justify-center w-full h-full text-on-surface-variant hover:text-on-surface" href="#">
